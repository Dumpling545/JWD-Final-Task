...
-- Schema hotel_system_database
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `hotel_system_database` DEFAULT CHARACTER SET utf8mb4 ;
USE `hotel_system_database` ;

-- -----------------------------------------------------
-- Table `hotel_system_database`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hotel_system_database`.`users` ;

CREATE TABLE IF NOT EXISTS `hotel_system_database`.`users` (
...
-- -----------------------------------------------------
-- Table `hotel_system_database`.`archived_reservations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hotel_system_database`.`archived_reservations` ;

CREATE TABLE IF NOT EXISTS `hotel_system_database`.`archived_reservations` (
  ...
  CONSTRAINT `fk_archived_reservations_users1`
    FOREIGN KEY (`user_id`)
    REFERENCES `hotel_system_database`.`users` (`id`)
    ON DELETE SET NULL
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `hotel_system_database`.`hotels`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hotel_system_database`.`hotels` ;

CREATE TABLE IF NOT EXISTS `hotel_system_database`.`hotels` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `hotel_system_database`.`m2m_administrator_hotel`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hotel_system_database`.`m2m_administrator_hotel` ;

CREATE TABLE IF NOT EXISTS `hotel_system_database`.`m2m_administrator_hotel` (
  ...
  CONSTRAINT `fk_m2m_administrator_hotel_hotels1`
    ...
    REFERENCES `hotel_system_database`.`hotels` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `hotel_system_database`.`rooms`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hotel_system_database`.`rooms` ;

CREATE TABLE IF NOT EXISTS `hotel_system_database`.`rooms` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `hotel_id` INT(10) UNSIGNED NOT NULL,
  `name` VARCHAR(100) NOT NULL,
...
-- -----------------------------------------------------
-- Table `hotel_system_database`.`reservations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hotel_system_database`.`reservations` ;

CREATE TABLE IF NOT EXISTS `hotel_system_database`.`reservations` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT(10) UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_reservations_rooms1`
    FOREIGN KEY (`room_id`)
    REFERENCES `hotel_system_database`.`rooms` (`id`)
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `hotel_system_database`.`reviews`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hotel_system_database`.`reviews` ;

CREATE TABLE IF NOT EXISTS `hotel_system_database`.`reviews` (
  ...
  CONSTRAINT `fk_reviews_reservations1`
    ...
    REFERENCES `hotel_system_database`.`archived_reservations` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `hotel_system_database`.`room_features`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hotel_system_database`.`room_features` ;

CREATE TABLE IF NOT EXISTS `hotel_system_database`.`room_features` (
  `room_id` INT(10) UNSIGNED NOT NULL,
...
USE `hotel_system_database`$$
DROP TRIGGER IF EXISTS `hotel_system_database`.`date_range_validator` $$
USE `hotel_system_database`$$
CREATE
DEFINER=`root`@`localhost`
TRIGGER `hotel_system_database`.`date_range_validator`
BEFORE INSERT ON `hotel_system_database`.`reservations`
FOR EACH ROW
BEGIN
...
GRANT ALL PRIVILEGES ON `hotel_system_database`.* TO `hotel_system_user`@`localhost` IDENTIFIED BY 'very_strong_password_I_promise';
