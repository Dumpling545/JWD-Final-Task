...
/**
 * Entity needed to filter room list on Service level. Unlike {@link
 * RoomSearchDatabaseFilter}, contains 'initialized' flags for primitive
 * properties, also contains {@link String} location query instead of  {@link
 * by.tc.task05.entity.Location}
 */
public class RoomSearchServiceFilter implements Serializable {
	...
	private boolean longitudeInitialized = false;
	...
	public boolean isLongitudeInitialized() {
		return longitudeInitialized;
	}
	...
	public boolean equals(Object o) {
		...
		if (latitudeInitialized != filter.latitudeInitialized) {
			return false;
		}
		if (Double.compare(filter.latitude, latitude) != 0) {
			return false;
		}
		if (longitudeInitialized != filter.longitudeInitialized) {
			return false;
		}
		if (Double.compare(filter.longitude, longitude) != 0) {
			return false;
		}
		...
		if (numberOfBeds != filter.numberOfBeds) {
			return false;
		}
	...
	public int hashCode() {
		...
		result = 31 * result + (longitudeInitialized ? 1 : 0);
	...
	public String toString() {
		return "RoomSearchServiceFilter{" + "checkInDate=" + checkInDate +
				...
				", latitude=" + latitude + ", longitudeInitialized=" +
				longitudeInitialized + ", longitude=" + longitude +
