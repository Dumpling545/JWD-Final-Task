...
/**
 * {@link Reservation} entity that extended with information about client, room
 * and hotel. Also this entity matches database structure of archived database.
 */
public class ExtendedReservation extends Reservation {
	...
	/**
	 * Status of archived reservation which means that reservation has been
	 * rejected by hotel owner
	 */
	public static final int REJECTED = 0;
	/**
	 * Status of archived reservation which means that reservation has been
	 * ended successfully (client checked out from room)
	 */
