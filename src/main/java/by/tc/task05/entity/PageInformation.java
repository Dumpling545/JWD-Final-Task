...
/**
 * Entity that used to transfer information about pages from 'list' webpages:
...
public class PageInformation implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (pageInitialized != that.pageInitialized) {
			return false;
		}
		if (page != that.page) {
			return false;
		}
		if (pageSizeInitialized != that.pageSizeInitialized) {
			return false;
		}
