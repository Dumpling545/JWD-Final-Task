...
public class GoToAddRoomPage extends AuthorizedUserCommand {
    private static final String ADD_ROOM_JSP_LOCATION =
    ...
    public void executeAuthorized(int userId, HttpServletRequest request,
        ...
        RequestDispatcher requestDispatcher =
                request.getRequestDispatcher(ADD_ROOM_JSP_LOCATION);
