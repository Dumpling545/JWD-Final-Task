...
public class GoToUserReservationsPage extends AuthorizedUserCommand {
    ...
    public void executeAuthorized(int userId, HttpServletRequest request,
        ...
        ListPart<ExtendedReservation> reservations =
                reservationService.getByUser(userId, pageInfo, archived);
        request.setAttribute(RESERVATIONS_ATTRIBUTE_KEY, reservations.getSubList());
