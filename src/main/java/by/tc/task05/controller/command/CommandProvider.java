...
public class CommandProvider {
	...
	public CommandProvider() {
		...
		commands.put(CommandName.GOTOSETROOMICONPAGE,
				new GoToSetRoomIconPage());
		commands.put(CommandName.SETROOMICON, new SetRoomIcon());
		commands.put(CommandName.GOTOROOMPAGE, new GoToRoomPage());
		commands.put(CommandName.GOTOADDROOMFEATUREPAGE,
				new GoToAddRoomFeaturePage());
		commands.put(CommandName.ADDROOMFEATURE, new AddRoomFeature());
		commands.put(CommandName.GOTOCHANGEROOMFEATUREPAGE,
				new GoToChangeRoomFeaturePage());
		commands.put(CommandName.CHANGEROOMFEATURE, new ChangeRoomFeature());
		commands.put(CommandName.GOTODELETEROOMFEATUREPAGE,
				new GoToDeleteRoomFeaturePage());
		commands.put(CommandName.DELETEROOMFEATURE, new DeleteRoomFeature());
		commands.put(CommandName.GOTOUSERRESERVATIONSPAGE,
				new GoToUserReservationsPage());
		commands.put(CommandName.BOOK, new Book());
		commands.put(CommandName.ARCHIVERESERVATION, new ArchiveReservation());
		commands.put(CommandName.GOTOCANCELRESERVATIONPAGE,
				new GoToCancelReservationPage());
		commands.put(CommandName.GOTOHOTELRESERVATIONSPAGE,
				new GoToHotelReservationsPage());
		commands.put(CommandName.GOTOROOMRESERVATIONSPAGE,
				new GoToRoomReservationsPage());
