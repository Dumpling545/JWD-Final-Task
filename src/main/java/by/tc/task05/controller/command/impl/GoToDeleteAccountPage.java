...
public class GoToDeleteAccountPage extends AuthorizedUserCommand {
    private static final String DELETE_ACCOUNT_JSP_LOCATION =
    ...
    private static final String COMMAND_VALUE = CommandName.DELETEACCOUNT.name();
    ...
    public void executeAuthorized(int userId, HttpServletRequest request,
        ...
        RequestDispatcher requestDispatcher =
                request.getRequestDispatcher(DELETE_ACCOUNT_JSP_LOCATION);
