...
public class ExceptionMessageMapper {
	...
	private static final String CANNOT_CREATE_REVIEW_ERROR =
			"cannotCreateReviewError";
	private static final String INVALID_RATING_ERROR =
			"ratingError";
	...
	public static String getKey(Command command, ServiceException ex) {
		...
		} else if (ex instanceof CannotCreateReviewException) {
			return CANNOT_CREATE_REVIEW_ERROR;
		} else if (ex instanceof InvalidRatingException) {
