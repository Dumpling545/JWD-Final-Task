...
public class RoomValidatorImpl implements RoomValidator {
    ...
    public void validateFilter(RoomSearchServiceFilter filter)
        ...
        dateRangeValidator.validateRange(filter.getCheckInDate(), filter.getCheckOutDate(), false);
        ...
        if ((filter.getRatingLowBound() != NO_REVIEW_RATING && filter.getRatingLowBound() < MIN_RATING) ||
